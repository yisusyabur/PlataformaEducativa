                        ...
                        <div class="col-auto">
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink" style="">
                                    <div class="dropdown-header">{{ __('Acciones') }}:</div>
                                    <a class="dropdown-item" data-toggle="modal"  data-target="#comment{{ $comment->id }}">
                                    <i class="fa fa-info pr-2"></i> @lang('Mostrar comentario')
                                    </a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Comentario {{ $comment->Mentor->name }}</h5>
